    ...
    variants: {
      variant: {
        ...
        error:
          'destructive group border-red-500 bg-red-500 text-gray-50 dark:border-red-900 dark:bg-red-900 dark:text-gray-50',
        sMessage:
          'bg-green-100 border border-green-400 text-green-700 p-4 rounded flex items-sart justify-between',
        iMessage:
          'bg-blue-100 border border-blue-400 text-blue-700 p-4 rounded flex items-sart justify-between',
        eMessage:
          'bg-red-100 border border-red-400 text-red-700 p-4 rounded flex items-sart justify-between',
      },
    },
    defaultVariants: {
      variant: 'default',
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn('text-sm opacity-90 text text-gray-950', className)}
    {...props}
  />
));
